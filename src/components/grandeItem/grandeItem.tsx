...
export default function GrandeItem() {
    ...
    return (
        <>
            <ProductPage name={grandeInfo.name} img={grandeInfo.img} discount={grandeInfo.discount} productDescription="Experience comfortable and easy travelling like never before with this coach bag. It features a zip closure, removable straps and multiple organization compartments to keep your valuables safe. Crafted from premium material, it is durable and lasts long." productParagraph={grandeInfo.description} safe={grandeInfo.safe} value={grandeInfo.price} imgCarousel={grandeInfo.img} />
            <Helmet>
