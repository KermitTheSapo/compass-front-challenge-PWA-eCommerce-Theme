...
export default function Arrivals() {
    ...
    return (
        <S.ArrivalsSection>
            ...
            <S.ArrivalList>
                <ItemArrival onClick={() => setGrandeStatus(true)} ImgSrc={grande} ImgAlt={""} itemName={"Grande"} Description={"Blossom Pouch"} Price={"$39.49"} link={window.screen.width > 768 ? "/grande" : ""} />
                {grandeStatus && <>
                ...
                <ItemArrival onClick={() => setBokerStatus(true)} ImgSrc={boker} ImgAlt={""} itemName={"Boker"} Description={"Blossom"} Price={"$34.55"} link={window.screen.width > 768 ? "/boker" : ""} />
                {bokerStatus && <>
                ...
                <ItemArrival onClick={() => setCoachStatus(true)} ImgSrc={coach} ImgAlt={""} itemName={"Coach"} Description={"Leather Coach Bag"} Price={"$54.69"} link={window.screen.width > 768 ? "/coach" : ""} />
                {coachStatus && <>
                ...
                <ItemArrival onClick={() => setRemusStatus(true)} ImgSrc={remus} ImgAlt={""} itemName={"Remus"} Description={"Brown Strap Bag"} Price={"$57.00"} link={window.screen.width > 768 ? "/remus" : ""} />
                {remusStatus && <>
                ...
                <ItemArrival onClick={() => setCollosalStatus(true)} ImgSrc={collosal} ImgAlt={""} itemName={"Collosal"} Description={"Tall Heels"} Price={"$40.00"} link={window.screen.width > 768 ? "/collosal" : ""} />
                {collosalStatus && <>
                ...
                <ItemArrival onClick={() => setBoujeeStatus(true)} ImgSrc={boujee} ImgAlt={""} itemName={"boujee"} Description={"Black Bag"} Price={"$56.49"} link={window.screen.width > 768 ? "/boujee" : ""} />
                {boujeeStatus && <>
