...
export default function Boujee() {
    ...
    return (
        <>
            ...
            <ProductPage name={products[3].name} img={products[3].img} discount={products[3].discount} productDescription="Experience comfortable and easy traveling like never before with this coach bag. It features a zip closure, removable straps and multiple organization compartments to keep your valuables safe. Crafted from premium material, it is durable and lasts long." productParagraph={products[3].paragraph} safe={products[3].safe} value={products[3].price} imgCarousel={products[3].img} />
        </>
    )
}