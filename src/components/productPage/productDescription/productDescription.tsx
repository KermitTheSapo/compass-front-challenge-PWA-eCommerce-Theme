    ...
    return (
        <S.ProductDescription>
            ...
            {modalProductDescription && <S.ProductDescriptionParagraph>
                Experience comfortable and easy traveling like never before with this coach bag. It features a zip closure, removable straps and multiple organization compartments to keep your valuables safe. Crafted from premium material, it is durable and lasts long.
